...
const PostsList = () => {
  const posts = [
    {
      id: 1,
      caption: "Distributed food packages to 50 families in downtown area today. The smiles on their faces made it all worth it! 🙏",
    ...
    {
      id: 2,
      caption: "Set up a medical camp in collaboration with local doctors. Provided free checkups and medicines to over 100 people.",
      date: "2024-03-14T09:15:00",
      image: "https://images.unsplash.com/photo-1576765608535-5f04d1e3f289?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
    }
  ];
