...
const mockData = {
    volunteers: [
        { position: [40.7128, -74.0060] as [number, number], type: 'volunteer' as const },  // Sample test data
        { position: [40.7580, -73.9855] as [number, number], type: 'volunteer' as const },
    ],
    victims: [
        { position: [40.7282, -73.9942] as [number, number], type: 'victim' as const },
        { position: [40.7549, -73.9840] as [number, number], type: 'victim' as const },
    ],
    stats: {
        aidDelivered: 1234,
        activeVolunteers: 89,
    ...
    updates: [
        { id: 1, message: "Emergency supplies delivered to Downtown area", time: "10 mins ago" },
        { id: 2, message: "New volunteer team deployed to East Side", time: "25 mins ago" },
        { id: 3, message: "Medical supplies needed in North District", time: "45 mins ago" },
    ],
};
