  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="bg-white rounded-lg shadow-xl p-6 md:p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Emergency Assistance Request</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div>
                <label htmlFor="name" className="block text-sm font-medium text-gray-700 p-1.5">
                Full Name
                </label>
              <input
                type="text"
            ...
            <div>
              ...
              <input
                ...
                onChange={e => setForm(prev => ({ ...prev, peopleCount: parseInt(e.target.value) }))}
              />
            </div>
            ...
            <div>
              ...
              <PhotoUpload onImageSelect={handlePhotoSelect} previewUrl={imagePreview} />
            </div>
            ...
            <div>
              ...
              <LocationPicker
                onLocationSelect={location => setForm(prev => ({ ...prev, location }))}
              />
            </div>
          </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  In case of immediate life-threatening emergency, please contact local emergency services directly.
                </p>
              </div>
            </div>
          </div>
